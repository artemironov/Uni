        ...
        <?php if(have_posts() ) : while( have_posts() ) : the_post(); setPostViews(get_the_ID()); ?>
            <article class="content-container">
                <div class="article-container">
                    ...
                    <div class="entry-top">
                        <div class="entry-top-left">
                            <div class="entry-date">Опубликовано: <?php // the_modified_date('j F Y'); ?><?php the_date('j F Y'); ?></div>
                ...
                <aside class="sidebar">
                    ...
                    <?php } ?>
                    <div class="widget">
                        <!--<div class="w-title"><span>Еще статьи</span></div>-->
                    ...
                    <div class="ads-sidebar">
                        <?php $ip = $_SERVER['REMOTE_ADDR'];
                            ...
                            if( $country_code == US || $country_code == DE ) {
                                $ads = get_field('ads-sidebar-en', 'option');
                            } else {
